  ...
  <template>
    <el-table
      ...
      <template slot-scope="scope">
        <el-button @click="$router.push({path:`/categories/edit/${scope.row._id}`})" type="text" size="small">编辑</el-button>
...
<script>
  export default {
    methods: {
      ...
      async getData(){
      	let res=await this.$http.get("/rest/categories",{page:1,size:20})
